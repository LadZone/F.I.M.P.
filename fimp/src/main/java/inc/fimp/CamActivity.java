...
public class CamActivity extends ActionBarActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(res_id==R.id.action_logout)
        {
            ...
            finish();
            startActivity(new Intent(CamActivity.this, LoginActivity.class));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(res_id==R.id.nav_bio){
            ...
            View view = (LayoutInflater.from(CamActivity.this)).inflate(R.layout.user_input, null);

            AlertDialog.Builder alertBuilder = new AlertDialog.Builder(CamActivity.this);
        ...
        if(res_id==R.id.nav_camera){
            ...
            Toast.makeText(CamActivity.this, "Camera", Toast.LENGTH_SHORT).show();
        }

        else if(res_id==R.id.nav_joystick){
            startActivity(new Intent(CamActivity.this, CamActivity.class));
            Toast.makeText(CamActivity.this, "Joystick", Toast.LENGTH_SHORT).show();
        }

        else if(res_id==R.id.nav_home){
            startActivity(new Intent(CamActivity.this, UserActivity.class));
            Toast.makeText(CamActivity.this, "Home", Toast.LENGTH_SHORT).show();
        }
            ...
            startActivity(new Intent(CamActivity.this, AboutUs.class));
            Toast.makeText(CamActivity.this, "About Us", Toast.LENGTH_SHORT).show();
        }
